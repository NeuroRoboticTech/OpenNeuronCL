...
__constant float aryST_Decrement[2] = {0.039210598915815353f, 0.039210598915815353f};
...
__kernel void FastSpikingSynapse(unsigned int iTimeSlice, unsigned char iActiveArray, 
